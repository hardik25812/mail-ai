...
import { DashboardMockup, EmailMockup } from "@/components/software-mockups"
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 mt-8">
            <motion.div
              className="relative h-48 bg-black/20 rounded-lg p-4 backdrop-blur-sm border border-white/10 shadow-xl"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4, duration: 0.5 }}
            >
              <DashboardMockup />
              <div className="absolute bottom-4 left-4 bg-black/50 backdrop-blur-sm px-3 py-1 rounded-full text-xs text-white/80">
                AI Dashboard
              </div>
            </motion.div>
